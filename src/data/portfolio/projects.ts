...
export const projects: Project[] = [
  {
    ...
    description:
      'Developed an instanced browser execution graph compiling custom WebGPU shaders. Scales neural inferences dynamically across 1,000 parallel clients.',
  ...
  },
  {
    ...
    description:
      'Designed a high-frequency communications network solver utilizing dynamic navigation meshes and A* pathfinders.',
