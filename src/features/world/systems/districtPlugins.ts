...
export const DISTRICT_PLUGINS: Record<ZoneTheme, DistrictPlugin | null> = {
  'spawn': {
    ...
    component: React.lazy(() => import('../zones/SpawnPlazaScene').then((m) => ({ default: m.SpawnPlazaScene }))),
  },
  'ai-research': {
    id: 'ai-research',
    name: 'Neural AI Research District',
    component: React.lazy(() => import('../../districts/ai-lab/scene/AIResearchScene').then((m) => ({ default: m.AIResearchScene }))),
  },
